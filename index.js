...
function checkCollision(rock) {
  ...
  if (top > 360) {
    ...
    const dodgerRightEdge = positionToInteger(DODGER.style.left) + 40; //changed from 0

    const rockLeftEdge = positionToInteger(rock.style.left)

    // : The rock is 20 pixel's wide -- how do we get the right edge?
    const rockRightEdge = positionToInteger(rock.style.left) + 20 ;  //changed from 0
